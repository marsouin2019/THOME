  ...
  <nav class="menu">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-2">
                        <h3>Ours Networks <span class="badge badge-secondary"><i class="fas fa-caret-square-down"></i></span></h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-9">
    ...
    <script src="http://localhost/location-tout-genre.com/js/traitement.js"></script>
</body>
</html>